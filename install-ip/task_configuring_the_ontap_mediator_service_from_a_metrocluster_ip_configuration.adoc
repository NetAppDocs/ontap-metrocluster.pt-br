...
* O suporte para monitoramento de múltiplas configurações de IP do MetroCluster usando uma única instância do ONTAP Mediator depende de você configurar o ONTAP Mediator com HTTPS ou iSCSI. Para mais informações, consulte link:concept_mediator_requirements.html#mediator-multiple-mccip["Utilize ONTAP Mediator para monitorar várias configurações de IP MetroCluster"].
