...
[role="lead"]
Identificar os componentes de hardware e software necessários e suportados para uma configuração IP MetroCluster .  Analise as convenções de nomenclatura que os exemplos de documentação utilizam para os componentes.
...
*Nota:* A velocidade de 25 GbE requer o adaptador transceptor MAM1Q00A-QSA28.
...
NOTE: Os nomes dos agregados devem ser únicos em todos os sites MetroCluster. Isso significa que você não pode ter dois agregados diferentes com o mesmo nome no site A e no site B.
