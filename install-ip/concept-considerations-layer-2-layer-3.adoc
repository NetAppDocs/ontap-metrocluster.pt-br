...
---
= Requisitos para implantar configurações de IP do MetroCluster em redes compartilhadas de camada 2 ou camada 3
:allow-uri-read: 
...
image::../media/MCC_layer2.png[Configuração de rede da camada 2 do MetroCluster]
...
image::../media/mcc_layer3_backend.png[Configuração de rede de backend da camada 3 do MetroCluster]
...
image::../media/switch_traffic_with_cisco_switches.png[Configurações necessárias ao usar switches Cisco validados pela NetApp para tráfego MetroCluster]
...
image::../media/switch_traffic_with_broadcom_switches.png[Configurações necessárias para rede compartilhada ao usar switches IP Broadcom]
