...
+
** A partir do ONTAP 9.18.1, plataformas com uma velocidade de porta IP de MetroCluster de 100Gbps exigem uma velocidade mínima de link ISL de 100Gbps. Usar uma velocidade ISL diferente requer uma Feature Product Variance Request (FPVR). Para registrar uma FPVR, entre em contato com sua equipe de vendas da NetApp.
+
