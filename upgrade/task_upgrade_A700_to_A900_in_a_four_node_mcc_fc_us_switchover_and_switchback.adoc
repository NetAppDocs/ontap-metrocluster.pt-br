...
. Siga os passos em: link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#add-mcc-config-tb["Adição de configurações do MetroCluster"] na seção _Instalação e Configuração do Desempate do MetroCluster_.
