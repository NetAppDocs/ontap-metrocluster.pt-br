...
Você deve mover LIFs de dados para uma porta comum, remover VLANs e grupos de interface nos controladores antigos e desinstalar fisicamente os controladores.
