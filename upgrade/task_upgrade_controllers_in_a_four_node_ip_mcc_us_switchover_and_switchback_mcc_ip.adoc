...
.Sobre esta tarefa
* Você precisa dos UUIDs e IDs de sistema identificados anteriormente no procedimento de atualização no <<gather_info_so_sb,Reúna informações antes da atualização>>.
