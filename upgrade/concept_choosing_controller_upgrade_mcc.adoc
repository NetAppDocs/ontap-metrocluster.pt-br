...
* Nota 4: As atualizações de sistemas integrados (discos e controladores no mesmo chassi) exigem a substituição dos módulos de controlador, mantendo o chassi e os discos existentes.
...
image:../media/manual-upgrade-combination-group-2-a90-fas90-updated.png["Mostra as combinações de atualização suportadas para as plataformas do grupo 2"]
