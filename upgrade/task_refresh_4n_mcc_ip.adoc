...
Desempate
 a| 
link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#add-metrocluster-configurations["Adição de configurações do MetroCluster"] na _Instalação e Configuração do Desempate do MetroCluster_.
