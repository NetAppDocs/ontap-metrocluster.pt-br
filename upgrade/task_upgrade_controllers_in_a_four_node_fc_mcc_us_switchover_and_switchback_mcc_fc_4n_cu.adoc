...
e3a, e3b
 a| 
Nenhuma porta correspondente. Após a atualização, recrie as portas do cluster. link:task_prepare_cluster_ports_on_the_exist_controller.html["Preparando portas do cluster em um módulo do controlador existente"]
