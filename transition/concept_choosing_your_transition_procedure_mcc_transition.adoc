...
Sem interrupções
 a| 
Novas prateleiras de armazenamento são necessárias nas novas plataformas.  Após a conclusão da transição, os controladores, gabinetes e discos antigos são removidos do cluster.
 a| 
...
*Nota:* Este procedimento suporta as seguintes transições de FC para IP:

* De uma configuração MetroCluster FC de quatro nós para uma configuração MetroCluster IP de quatro nós
* De uma configuração MetroCluster FC de oito nós para uma configuração MetroCluster IP de oito nós
