...
NOTE: Se você estiver realizando uma transição de FC de quatro nós para IP de oito nós, poderá aplicar o RCF de FC de quatro nós para IP de oito nós antes de adicionar o segundo grupo de DR. Você não precisa aplicar o RCF de FC de quatro nós para IP de quatro nós primeiro.
