...
. Após substituir a peça, devolva a peça defeituosa à NetApp, conforme descrito nas instruções de RMA que acompanham o kit. Consulte a página link:https://mysupport.netapp.com/site/info/rma["Substituição  Devolução artigo"^] para obter mais informações.
