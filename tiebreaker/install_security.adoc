...
+
** A criptografia de dados em repouso é suportada. link:https://mariadb.com/docs/server/security/encryption/data-at-rest-encryption/data-at-rest-encryption-tde-fundamentals["Saiba mais sobre criptografia de dados em repouso"^]
...
+
link:https://mariadb.com/docs/server/security/securing-mariadb["Protegendo o MariaDB"^]
...
.O que se segue?
link:install-choose-procedure.html["Escolha o procedimento de instalação"] para instalar ou atualizar o Tiebreaker.
