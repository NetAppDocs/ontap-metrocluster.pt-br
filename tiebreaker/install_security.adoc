...
+
** A criptografia de dados em repouso é suportada.link:https://mariadb.com/docs/server/security/securing-mariadb/securing-mariadb-encryption/encryption-data-at-rest-encryption/data-at-rest-encryption-overview["Saiba mais sobre criptografia de dados em repouso"^]
