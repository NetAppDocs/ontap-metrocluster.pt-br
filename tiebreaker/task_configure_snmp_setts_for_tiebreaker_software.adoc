...
---
= Configurar as configurações SNMP para o software MetroCluster Tiebreaker
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.O que se segue?
link:concept_monitoring_the_mcc_configuration.html["Monitore a configuração do MetroCluster"]
