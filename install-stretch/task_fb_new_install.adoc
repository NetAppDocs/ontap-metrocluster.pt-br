...
image::../media/workflow_bridge_installation_and_configuration.gif[Fluxo de trabalho para instalação e configuração de ponte FC para SAS]
...
image::../media/mcc_cabling_bridge_and_sas3_stack_with_7500n_and_multiple_stacks.gif[Configuração de cabeamento FibreBridge do MetroCluster com múltiplas pilhas SAS3]
